...
Tools
-----
* ```hashcat. This can crack password from hashes based on word dictionaries. There are tones of algorithms built-in. Good dictionary is important. The link is here: [hashcat offical link](http://www.hashcat.net/ "hashcat offical link").``` 
```rainbow table generator/cracker: rainbowcrack (rcrack, rt2rtc, rtc2rt, rsort, rtgen) The link is here: [rainbow crack offical link](http://project-rainbowcrack.com// "project-rainbowcrack").```
