...
Tools
-----
```hashcat. This can crack password from hashes based on word dictionaries. There are tones of algorithms built-in. Good dictionary is important.```
```rainbow table generator/cracker: rainbowcrack (crack, rt2rtc, rtc2rt, rsort, rtgen)```
